...
1. Create a browser source using the following URL: `https://github.com/agnes0109/OBSStreamPomodoro/`
   - To customise the study and break time lengths use the following URL instead: `https://github.com/agnes0109/OBSStreamPomodoro/?pomodoro=25&shortBreak=5&longBreak=5` (replacing `45`, `10` and `15` with minute values as desired.)
